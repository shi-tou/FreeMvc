...
namespace FreeMvc.Dao
{
    ...
    public sealed partial class MySqlHelper
    {
        ...
        public void BatchInsert(List<string> listSql, List<MySqlParameter[]> listParam)
        {
            BatchInsert(ConnectionString, listSql, listParam);
        }
        ...
        public static void BatchInsert(string connectionString,List<string> listSql, List<MySqlParameter[]> listParam)
        {
            MySqlConnection connection = new MySqlConnection(connectionString);
            ...
            try
            {
                ...
                for (int i = 0; i < listSql.Count; i++)
                {
                    ...
                    command.Parameters.AddRange(listParam[i]);
